...
use crate::{
    find_symbol_error,
    loader::{SymbolData, SymbolInfo},
    ELFLibrary, Result,
};

#[allow(unused)]
#[derive(Debug)]
pub(crate) enum LibraryExtraData {
    Internal(crate::loader::ExtraData),
    #[cfg(feature = "ldso")]
    External(crate::ldso::ExtraData),
}
...
pub(crate) struct RelocatedLibraryInner {
    ...
    #[cfg(feature = "debug")]
    pub(crate) link_map: crate::debug::DebugInfo,
    pub(crate) extra: LibraryExtraData,
}
...
impl RelocatedLibrary {
    ...
    #[cfg(feature = "std")]
    pub(crate) fn get_extra_data(&self) -> Option<&crate::loader::ExtraData> {
        match &self.inner().extra {
    ...
    pub unsafe fn get_version<'lib, T>(
        ...
        let version = crate::loader::SymbolVersion::new(version);
        self.inner()
            .symbols()
